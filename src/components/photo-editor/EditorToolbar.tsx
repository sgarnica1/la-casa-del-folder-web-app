  ...
  return (
    <div className="grid grid-cols-4 gap-2">
      <Button
        ...
        onClick={onFill}
        disabled={disabled}
        className="flex flex-col items-center justify-center h-20 p-2 border border-gray-300 bg-white hover:bg-gray-50 text-black hover:text-black"
      >
      ...
      <Button
        ...
        disabled={disabled}
        className={`flex flex-col items-center justify-center h-20 p-2 border border-gray-300 bg-white hover:bg-gray-100 text-black hover:text-black ${showGrid ? 'bg-gray-100' : ''}`}
      >
